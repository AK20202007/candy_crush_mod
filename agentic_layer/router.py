...
from .agents import CrossingSignalAgent, FallbackAgent, OrientationAgent, SafetyAgent, SidewalkAgent, TargetFindingAgent, WayfindingAgent
...
class AgenticNavigationRouter:
    ...
    def _apply_anti_spam(self, ctx: FrameContext, decision: AgentDecision) -> AgentDecision:
        ...
        interval = self.min_urgent_repeat_interval_ms if decision.priority >= 90 else self.min_repeat_interval_ms
